  ...
  (0, _react.useEffect)(() => {
    ...
    function tick() {
      timerId = window.setTimeout(() => {
        forceUpdate(); // avoid pile-up of setInterval callbacks,
...
function formatRelativeTime(date) {
  ...
  var parsedDate = date instanceof Date ? date : new Date(date); // Invalid date? Return empty timestamp and `null` as refresh interval, to save us from
